 ...
 * @author DELL
 */
public class CountConditionsCs {
    private final String code;
    private final String split;
    private final int increment;

    /*CountConditionsCs(String codeFinal2, String aif, int i) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }*/

    public CountConditionsCs(String code, String split, int increment) {
    ...
    public int getCount() {
        ...
        for (int i = 0; i < words.length; i++) {
            ...
            if (words[i].charAt(0) == '(' || words[i].charAt(1) == '(') {
                ...
                CheckInsideBracketsCS brackets = new CheckInsideBracketsCS(words[i]);
